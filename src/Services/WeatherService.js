...
const generateLondonWeatherData = () => {
    const generatedWeatherData = {
        temperature: faker_1.faker.datatype.number({ min: -15, max: 30 }),
        humidity: faker_1.faker.datatype.number({ min: 79, max: 86 }),
        wind: faker_1.faker.datatype.number({ min: 2, max: 78 }),
        rain: faker_1.faker.datatype.number({ min: 65, max: 75 }),
    };
